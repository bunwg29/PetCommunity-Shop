...
export const index = async (req: Request, res: Response) => {
    ...
    const order = await ToyOrderModel.find().limit(pagination.limitItems).skip(pagination.skip);
...
export const confirmOrder = async (req: Request, res: Response) => {
    ...
    const order = await ToyOrderModel.updateOne({_id: orderId}, { status: "Confirmed"});
