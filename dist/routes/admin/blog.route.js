...
exports.blogAdminRoutes = void 0;
...
router.patch('/edit/:id', upload.single('thumbnail_photo'), uploadCloud.uploadSingle, controller.blogPatch);
router.delete('/delete/:id', controller.deleteBlog);
exports.blogAdminRoutes = router;
