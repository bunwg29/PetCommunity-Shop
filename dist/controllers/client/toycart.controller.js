  ...
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (cart.products.length > 0) {
      for (const product of cart.products) {
        const productInfo = yield toyPet_model_1.default
          .findOne({
...
const createCart = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (existProductInCart) {
      const addProduct = yield toyCart_model_1.default.updateOne(
      ...
      const newProduct = yield toyCart_model_1.default.updateOne(
        { _id: foodCart },
