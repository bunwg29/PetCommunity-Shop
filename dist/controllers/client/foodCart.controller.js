...
const createCart = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (existProductInCart) {
        const addProduct = yield foodCart_model_1.default.updateOne({ _id: foodCart, 'products.product_id': productId }, {
            $set: {
        ...
        const newProduct = yield foodCart_model_1.default.updateOne({ _id: foodCart }, { $push: { products: { product_id: productId, quantity: quantity } } });
        if (newProduct) {
            req.flash('success', 'You have added to your food pet cart');
        }
    }
...
const deleteProduct = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const productId = req.params.productId;
    try {
        const cart = yield foodCart_model_1.default.updateOne({ _id: foodCart }, {
