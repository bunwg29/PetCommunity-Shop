...
const createCart = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const cart = yield foodCart_model_1.default.findOne({ _id: cartId });
    const existProductInCart = cart.products.find((item) => item.product_id == productId);
    if (existProductInCart) {
        const addProduct = yield foodCart_model_1.default.updateOne({ _id: cartId, 'products.product_id': productId }, {
            $set: {
        ...
        const newProduct = yield foodCart_model_1.default.updateOne({ _id: cartId }, { $push: { products: { product_id: productId, quantity: quantity } } });
        if (newProduct) {
            req.flash('success', 'You have added to your food pet cart');
        }
    }
...
const deleteProduct = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const productId = req.params.productId;
    try {
        const cart = yield foodCart_model_1.default.updateOne({ _id: cartId }, {
