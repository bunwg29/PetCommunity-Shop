...
const foodOrder_model_1 = __importDefault(
  require('../../models/foodOrder.model')
);
  ...
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (cart) {
      try {
        ...
        yield order.save();
        yield foodCart_model_1.default.updateOne(
          { _id: foodCart },
          { products: [] }
        );
...
const renderOrderSuccess = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const orderDate = (0, moment_1.default)(order.createdAt).format(
      'Do MMMM YYYY'
    );
