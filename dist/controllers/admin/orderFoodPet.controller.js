...
const index = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const pagination = yield (0, pagination_helper_1.Pagination)(req, foodOrder_model_1.default, {});
    const order = yield foodOrder_model_1.default.find()
...
const detail = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const orderDetail = yield foodOrder_model_1.default.findOne({ _id: orderId });
...
const confirmOrder = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const order = yield foodOrder_model_1.default.updateOne({ _id: orderId }, { status: 'Confirmed' });
    if (order) {
        req.flash('success', 'This order has been confirmed');
        res.redirect(`/${adminPrefix_1.systemConfig.prefixAdmin}/orderfoodpet`);
    }
});
exports.confirmOrder = confirmOrder;
const deleteOrder = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const orderId = req.params.id;
    const order = yield foodOrder_model_1.default.findByIdAndDelete(orderId);
    if (order) {
        res.json({
            code: 200,
        });
